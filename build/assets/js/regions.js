$(document).ready(function () {
   ...
   $('path[data-district^="CFO"]').on( 'mouseenter', function () {
      $('#main').css( 'opacity', '0');
      $('#CFO').addClass('show-info');

   }).on( 'mouseleave', function () {
      $('#main').css( 'opacity', '1');
      $('#CFO').removeClass('show-info');
      // let element = document.getElementById('eDs5JmlP74F1');
      // element.svgatorPlayer.ready(player => player.play());
      // document.getElementById("eDs5JmlP74F1").svgatorPlayer.play();
   })
});
